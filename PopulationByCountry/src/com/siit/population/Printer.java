...
public class Printer {
    ...
    public static void countryFromAll(List<Country> countries, String country){
        countries.stream().filter(c -> c.getName().equals(country)).forEach(System.out::println);
    }
    ...
    public static String printPeaksOf(Country country){
        ...
        return "Max population: "
                ...
                + " reached in year "
                + country.getYearOfPopulation(country.getMaxPopulation())
                + "\n" +
                "Min population: "
                + country.getMinPopulation()
                + " reached in year "
                + country.getYearOfPopulation(country.getMinPopulation());
    }
}
